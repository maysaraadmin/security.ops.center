"""
Simple EDR and SIEM Launcher

This script starts both the EDR and SIEM services with minimal configuration.
"""
import os
import sys
import time
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('edr_siem_run.log')
    ]
)
logger = logging.getLogger('edr_siem_runner')
...
def main():
    ...
    # Give SIEM a moment to initialize
    time.sleep(2)
